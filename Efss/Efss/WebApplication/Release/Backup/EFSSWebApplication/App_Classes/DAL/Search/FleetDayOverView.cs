...
{
    public class FleetDayOverView
    {
        public static List<FleetDayOverView> SelectActiveFleetDay(int? currentPageNumber, int? pageSize, string sortExpression, int? companyId)
        {
            try
            {
                //Initialise Command
                SqlConnection con = ConnectionManager.CreateConnection(DataBase.Application);
                SqlCommand cmd = ConnectionManager.CreateProcedure(StoredProcedures.Select_Receivables_OverView_Day, con);
                ...
                //Execute Command
                var results = new List<FleetDayOverView>();
                using (con)
                {
                    con.Open();
                    ...
                    while (reader.Read())
                    {
                        results.Add(new FleetDayOverView(reader));
                    }
                }
        ...
        public FleetDayOverView(SqlDataReader reader)
        {
