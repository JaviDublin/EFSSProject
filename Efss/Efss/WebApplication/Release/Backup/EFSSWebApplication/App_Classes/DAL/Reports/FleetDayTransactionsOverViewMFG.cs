...
{
    public class FleetDayTransactionsOverViewMFG
    {
        public static List<FleetDayTransactionsOverViewMFG> SelectFleetDayTransactionsReportMFG(int? currentPageNumber, int? pageSize, string sortExpression, string month, string year, int fileId,int countryId)
        {
            try
            {
                //Initialise Command
                SqlConnection con = ConnectionManager.CreateConnection(DataBase.Application);
                SqlCommand cmd = ConnectionManager.CreateProcedure(StoredProcedures.Select_Fleet_DayReport_AddsDel_mfg, con);
                ...
                //Execute Command
                var results = new List<FleetDayTransactionsOverViewMFG>();
                using (con)
                {
                    con.Open();
                    ...
                    while (reader.Read())
                    {
                        results.Add(new FleetDayTransactionsOverViewMFG(reader));
                    }
                }
        ...
        public FleetDayTransactionsOverViewMFG(SqlDataReader reader)
        {
