...
namespace APP.App_UserControls.Fleet.ListViewYearManufacturer
{
    public partial class ListViewYearManufacturer : UserControlBase
    {
        ...
        public void LoadControlData(object sender, FilterEvents e, int? currentPage, int? pageSize, string sortExpression)
        {
            ...
            results = APP.Reports.FleetYearReportOverViewMFG.SelectFleetYearReportMFG(currentPage, pageSize, sortExpression, SessionHandler.FilterYearFleetYearTransReport, Convert.ToInt32(SessionHandler.FilterFileIdFleetYearTransReport), Convert.ToInt32(SessionHandler.SelectedFleetYearCountryId));
