<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListViewYearManufacturer.ascx.cs" Inherits="APP.App_UserControls.Fleet.ListViewYearManufacturer.ListViewYearManufacturer" %>
    ...
    <ContentTemplate>
        ...
        <asp:PlaceHolder ID="PlaceHolderData" runat="server">
            ...
            <div id="ResizableListView" class="ui-widget-content">
                <%-- ListView --%>
                <rad:ListView ID="ListViewFleetYearReportOverview" runat="server" ItemPlaceholderID="PlaceHolderDetails" LayoutTableID="tableFleetYearOverview" ItemTemplateRow="rowListViewDetails" DataKeyNames="ManufacturerId"  OnSorting="ListView_Sorting" LayoutTableClass="listviewtable" LayoutTableDefaultHeight="350" LayoutTableTheme="rad__listview-table" ResizableControl="ResizableListView" OnItemCommand="ListView_ItemCommand" >
                    <LayoutTemplate>
                        <table cellpadding="0" cellspacing="0" class="listviewtable" id="tableFleetYearOverview" runat="server" clientidmode="Static">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <rad:ListViewHeader ID="LinkButtonManufacturerName" runat="server" Text="<%$Resources:ListViewHeaders, ManufacturerName %>" CommandArgument="ManufacturerName" ToolTip="<%$Resources:ToolTips, ManufacturerName%>"></rad:ListViewHeader>
                                    </th>
                                    <th>
