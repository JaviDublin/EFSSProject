...
namespace APP.App_UserControls.Fleet.ListViewDay
{
    public partial class ListViewDay : UserControlBase
    {
        ...
        public void LoadControlData(object sender, FilterEvents e, int? currentPage, int? pageSize, string sortExpression)
        {
            ...
            results = APP.Reports.FleetDayTransactionsOverView.SelectFleetDayTransactionsReport(currentPage, pageSize, sortExpression,SessionHandler.FilterMonthFleetDayTransReport, SessionHandler.FilterYearFleetDayTransReport, Convert.ToInt32(SessionHandler.FilterFileIdFleetDayTransReport));
        ...
        protected void ListView_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            if (e.CommandName == "EditDetails")
            {
                ...
                string primaryDataKey = this.ListViewFleetDayReportOverview.DataKeys[dataItem.DisplayIndex].Values[0].ToString();

                SessionHandler.SelectedFleetDayCountryId = primaryDataKey;
