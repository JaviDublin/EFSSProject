<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListViewDay.ascx.cs" Inherits="APP.App_UserControls.Fleet.ListViewDay.ListViewDay" %>
        ...
        <asp:PlaceHolder ID="PlaceHolderData" runat="server">
            ...
            <div id="ResizableListView" class="ui-widget-content">
                ...
                <rad:ListView ID="ListViewFleetDayReportOverview" runat="server" ItemPlaceholderID="PlaceHolderDetails"
                    LayoutTableID="tableFleetDayOverview" ItemTemplateRow="rowListViewDetails" DataKeyNames="CountryId"
