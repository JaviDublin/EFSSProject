...
-- =============================================
CREATE PROCEDURE [dbo].[spFleetOverViewSelectTransactionManufacturer]
...
BEGIN
	...
	FROM [Staging.ActiveFleetTransactions] u
	...
	WHERE u.CompanyId = @companyId and u.FileId = @fileid and m.ManufacturerName = @searchTerm
	GROUP BY 
