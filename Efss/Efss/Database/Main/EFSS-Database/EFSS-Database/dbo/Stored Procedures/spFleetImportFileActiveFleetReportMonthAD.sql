...
-- =============================================
CREATE PROCEDURE [dbo].[spFleetImportFileActiveFleetReportMonthAD]
...
BEGIN
	...
	SELECT
	t.[count] as 'Count' , t.CountryId , t.CountryName , t.Total ,
	...
	WHERE u.DateYear = @year AND u.MonthNumber = @month AND u.FileId = @fileid
	GROUP BY u.CountryId ,  c.CountryName
	) AS t
